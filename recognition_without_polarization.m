clear all
% read the pattern
load_data = load('H_pattern_conductance_without');
H_pattern_conductance = load_data.H_pattern_conductance;
load_data = load('I_pattern_conductance_without');
I_pattern_conductance = load_data.I_pattern_conductance;
load_data = load('J_pattern_conductance_without');
J_pattern_conductance = load_data.J_pattern_conductance;
load_data = load('K_pattern_conductance_without');
K_pattern_conductance = load_data.K_pattern_conductance;
load_data = load('L_pattern_conductance_without');
